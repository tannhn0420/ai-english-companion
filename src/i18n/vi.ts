...
export const vi = {
  ...
  spkDrill: 'Luyện âm',
  spkStart: 'Bắt đầu',
  spkReadHintStt: 'Nghe câu mẫu rồi đọc to — app nhận diện và chấm từng từ.',
  spkReadHintRec: 'Thiết bị này không nhận diện giọng nói — bạn ghi âm rồi nghe lại so với mẫu.',
  spkSpeak: 'Đọc',
  spkListening: 'Đang nghe…',
  spkRecord: 'Ghi âm',
  spkStopRec: 'Dừng',
  spkRerecord: 'Ghi lại',
  spkNoMic: 'Không dùng được micro.',
  spkMicErr: 'Không nghe được — kiểm tra quyền micro rồi thử lại.',
  spkScore: 'Khớp {n}%',
  spkIeltsQ: 'Câu hỏi',
  spkRecordAnswer: 'Ghi âm câu trả lời',
  spkAnswerStt: 'Trả lời (nhận diện giọng nói)',
  spkAssess: '📊 Chấm điểm IELTS',
  spkAssessing: 'Đang chấm…',
  spkNextQ: 'Câu hỏi khác →',
  spkIeltsNeedKey: 'IELTS Speaking cần micro + key Gemini (chấm cả phát âm) hoặc trình duyệt hỗ trợ nhận diện giọng nói.',
  spkFluency: 'Trôi chảy',
  spkLexical: 'Từ vựng',
  spkGrammar: 'Ngữ pháp',
  spkPron: 'Phát âm',
